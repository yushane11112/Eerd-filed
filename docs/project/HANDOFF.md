...
1. 将 PlacementController 和地图工具继续扩展为完整建造模式：浏览器覆盖可营造绿态、确认成功后连续放置、拆除确认/退款平衡、桥头吸附、将道路/桥梁补线建议转为一键选择道路/桥梁工具并预览成本、以及更稳定的拖拽 E2E 断言。
2. 将正式营造成本表从硬编码首版规则推进为可调经济表，并补平衡审计文档。
