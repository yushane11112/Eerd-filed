...
1. 先做道路与街区质感：石路、土路、桥面、田埂、仓储堆场、集市外摆和水岸边界形成清晰城市结构。
2. 再做活动密度与状态反馈：居民、货车、服务访问、市场人流、仓储忙碌、缺货/仓满/停工状态在地图上更容易被看见。
3. 物流、卸货能力、升级经济表和浏览器 E2E 继续推进，但近期必须优先选择能转化为可见垂直切片或真实操作闭环的任务。
