    ...
    const aggregate = aggregatePerformanceSamples([
      {
        ...
        readPixels: { count: 0 },
        loadProfile: { appInitMs: 10, artworkProviderMs: 40, artworkPreloadAssetCount: 2, artworkDeferredAssetCount: 3, artworkPreloadLevelCount: 4, artworkPreloadVisibleBuildings: 80, artworkPreloadDetailedBuildings: 70, artworkTotalAssetCount: 5, artworkAtlasManifestMs: 3, artworkAtlasBlockingLoadMs: 30, artworkAtlasDeferredDispatchMs: 0.1, artworkAtlasBlockingEntryCount: 2, artworkAtlasDeferredEntryCount: 3, artworkAtlasBlockingTextureCount: 8, artworkAtlasDeferredTextureCount: 12, sceneSetupMs: 5, terrainMs: 4, firstSyncMs: 8, firstSyncDelayMs: 1, totalMs: 75 },
        graphicsContext: {
          canvasWidth: 1366,
          canvasHeight: 768,
          contextType: 'webgl2',
      ...
      },
      {
        ...
        readPixels: { count: 2 },
        loadProfile: { appInitMs: 20, artworkProviderMs: 120, artworkPreloadAssetCount: 4, artworkDeferredAssetCount: 1, artworkPreloadLevelCount: 8, artworkPreloadVisibleBuildings: 220, artworkPreloadDetailedBuildings: 96, artworkTotalAssetCount: 5, artworkAtlasManifestMs: 7, artworkAtlasBlockingLoadMs: 100, artworkAtlasDeferredDispatchMs: 0.3, artworkAtlasBlockingEntryCount: 4, artworkAtlasDeferredEntryCount: 1, artworkAtlasBlockingTextureCount: 32, artworkAtlasDeferredTextureCount: 8, sceneSetupMs: 9, terrainMs: 6, firstSyncMs: 16, firstSyncDelayMs: 2, totalMs: 180 },
        graphicsContext: {
          canvasWidth: 1366,
          canvasHeight: 768,
          contextType: 'webgl2',
      ...
      },
      {
        ...
        readPixels: { count: 0 },
        loadProfile: { appInitMs: 12, artworkProviderMs: 60, artworkPreloadAssetCount: 3, artworkDeferredAssetCount: 2, artworkPreloadLevelCount: 6, artworkPreloadVisibleBuildings: 160, artworkPreloadDetailedBuildings: 90, artworkTotalAssetCount: 5, artworkAtlasManifestMs: 5, artworkAtlasBlockingLoadMs: 50, artworkAtlasDeferredDispatchMs: 0.2, artworkAtlasBlockingEntryCount: 3, artworkAtlasDeferredEntryCount: 2, artworkAtlasBlockingTextureCount: 18, artworkAtlasDeferredTextureCount: 12, sceneSetupMs: 7, terrainMs: 5, firstSyncMs: 10, firstSyncDelayMs: 3, totalMs: 90 },
        consoleSummary: {
